...
fg_root = r"D:\data\AutoProgram\obj_det\fg"
...
bg_root = r"D:\data\AutoProgram\obj_det\bg"
bg_img_dirs = [
    r"stb_15um_white_bg",
    r"stb_15um_green_bg",
    r"stb_15um_red_bg",
...
for fg_img_dirs, name, dst_size, num_to_gen, num_to_paste in candidates:  # type: ignore
    dst_dir = rf"D:\data\AutoProgram\obj_det\synthesize_lv1\{name}_{str(dst_size)}"
