...
# =================================================短路检测业务===========================================================
def filter_ng(label_item):
    return label_item["label"].endswith("ng")


def filter_ok(label_item):
    return label_item["label"].endswith("ok")


src_dir_root = r"D:\data\Short_circuit\ic\horizontal"
dst_dir_root = r"D:\data\Short_circuit\short_circuit_ok"
default_margin_tblr = [0, 0, 0, 0]
crop_rectangle_items_for_folder(
    src_dir=src_dir_root,
    dst_dir=dst_dir_root,
    filter_func=filter_ok,
    margin_tblr=default_margin_tblr,
)
# =================================================短路检测业务===========================================================
